...
class TestDrishtiTab(BaseUITestCase):
    def test_drishti_tab_comprehensive(self):
        tab_name = "Drishti Tab: "
        ...
        chart_combo  = getattr(main_window, "_drishti_chart_combo", None)
        option_button = getattr(main_window, "_drishti_chart_option_button", None)
        info_label   = getattr(main_window, "_drishti_option_info_label", None)
        table1 = getattr(main_window, "_drishti_table1", None)
        table2 = getattr(main_window, "_drishti_table2", None)
        ...
        fallback_idx = getattr(horo_chart_tabs, "_drishti_tab_start", 9)
        ...
        total_charts = chart_combo.count() - 1 # EXclude DmXDn
