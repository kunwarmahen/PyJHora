...
class TestShodhayaTab(BaseUITestCase):
    def test_shodhaya_tab_comprehensive(self):
        tab_name = "Shodhaya Pindam Tab: "
        ...
        chart_combo  = getattr(main_window, "_shodhaya_chart_combo", None)
        option_button = getattr(main_window, "_shodhaya_chart_option_button", None)
        info_label   = getattr(main_window, "_shodhaya_option_info_label", None)
        table1 = getattr(main_window, "_shodhaya_table1", None)
        table2 = getattr(main_window, "_shodhaya_table2", None)
        ...
        fallback_idx = getattr(horo_chart_tabs, "_shodhaya_tab_start", 18)
