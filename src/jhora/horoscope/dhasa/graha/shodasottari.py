...
def get_dhasa_bhukthi(
    ...
    def _children_of(parent_lord):
        return list(_antardhasa(parent_lord))
...
def shodasottari_immediate_children(
    parent_lords,
    ...
    **kwargs,
    ...
    """
    Śoḍaśottarī (Sama) — returns ONLY the immediate (p -> p+1) children
    tiling the given parent span.

    Rules (match your base):
      • Antara order at EVERY level via: _antardhasa(parent_lord)
...
def get_running_dhasa_for_given_date(
    ...
    **kwargs,
    ...
    """
    Śoḍaśottarī (Sama) — narrow Mahā -> … -> target depth and return the full running ladder.
    """
    utils.validate_star_index(seed_star)
    global year_duration
    ...
    # ---- Level 1: Mahā via your base Śoḍaśottarī generator
    ...
    for depth in range(2, target_depth + 1):
        ...
        children = shodasottari_immediate_children(
