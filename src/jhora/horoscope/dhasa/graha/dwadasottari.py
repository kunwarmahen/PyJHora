...
def get_dhasa_bhukthi(
    ...
    """
    Returns a list of dhasa segments at selected depth L1..L6.
    ...
    def _recurse(
        ...
        """
        Equal split of immediate parent.
...
def dwadasottari_immediate_children(
    parent_lords,
    parent_start,
    ...
    **kwargs,
    ...
    """
    Dwadasottari immediate children under given parent span.
...
def get_running_dhasa_for_given_date(
    ...
    **kwargs,
    ...
    """
    Dwadasottari runner. Narrows Maha -> ... -> target level.
    ...
    for depth in range(const.MAHA_DHASA_DEPTH.ANTARA, target_depth + 1):
        ...
        children = dwadasottari_immediate_children(
