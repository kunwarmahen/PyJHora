...
def sataatbika_immediate_children(
    ...
    **kwargs,
    ...
    """
    Sataatbika — return ONLY the immediate (p -> p+1) children inside the given parent span.

    Matches your base:
      • Antara order at every level: _antardhasa(parent_lord, antardhasa_option)
      • Sama: child_years = parent_years / n
      • Child list tiles exactly within [parent_start, parent_end)
...
def get_running_dhasa_for_given_date(
    ...
    **kwargs,
    ...
    def _to_utils_periods(children_rows, parent_end_tuple, eps_seconds=1.0):
        ...
        Returns: [(lords_tuple, start_tuple), ...] + sentinel (any_lords, parent_end_tuple),
