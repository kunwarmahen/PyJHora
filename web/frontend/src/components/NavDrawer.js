...
const LINKS = [
  ...
  { to: "/strength", labelKey: "nav.strength", icon: <Gauge size={20} /> },
  { to: "/sade-sati", labelKey: "nav.sadeSati", icon: <Aperture size={20} /> },
  ...
  { to: "/chakras", labelKey: "nav.sarvatobhadra", icon: <Grid3x3 size={20} /> },
