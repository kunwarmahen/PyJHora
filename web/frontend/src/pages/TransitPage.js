...
import { Orbit, AlertCircle, ArrowLeft, User, Star, Calendar, TrendingUp, RotateCcw } from "lucide-react";
      ...
      <nav className="navbar">
        <div className="navbar-brand">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-md)", marginLeft: "var(--space-lg)" }}>
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: "1.5rem" }}>Transits (Gochara)</h1>
              <p style={{ margin: 0, fontSize: "0.875rem", color: "var(--text-secondary)" }}>
                Where the grahas move today, over your natal chart
              </p>
            </div>
          </div>
        </div>
